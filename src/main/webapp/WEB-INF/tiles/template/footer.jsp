        ...
        <div class="container">
            <div class="row py-4 d-flex align-items-center">
                ...
                <div class="col-md-6 col-lg-7 text-center text-md-right">
                    <div id="social">
                        <a class="facebook-btn sm-global-btn" href="#"></a>
                        <a class="instagram-btn sm-global-btn" href="#"></a>
                        <a class="telegram-btn sm-global-btn" href="#"></a>
                        <a class="viber-btn sm-global-btn" href="#"></a>
                        <a class="vk-btn sm-global-btn" href="#"></a>
                    </div>
                </div>
            </div>
        </div>
